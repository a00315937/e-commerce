    ...
    <script>
        $(document).ready(function() {
            $("#sendBtn").click(function() {
                window.location.href = "contactSubmission.html";
            });
        });
    </script>
...
<header>
	<div class="overlay">
<center><h3>Please fill out this form for your queries.</h3></center>
<style>
h2 {
...
<form>
        <table class="tab2" width="40%" align="center" bgcolor="#EC5800">
            <tr>
                <td><br></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" colspan="2">
                    <br><button type="submit" id="sendBtn">
